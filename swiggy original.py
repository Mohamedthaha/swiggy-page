...
class Login:
   ...
   def __init__(self,root):
      ...
      self.root.title("Login and registration system for swiggy")
   ...
   def loginform(self):
      ...
      self.img=ImageTk.PhotoImage(file="s1.jpg")
   ...
   def login(self):
      ...
      if self.username.get()=="" or self.password.get()=="":
         ...
         try:
            ...
            cur.execute('select * from customerdetails where username=%s and password=%s'
   ...
   def Register(self):
      ...
      self.img=ImageTk.PhotoImage(file="s7.jpg")
   ...
   def register(self):
      ...
      if self.entry.get()==""or self.entry2.get()==""or self.entry3.get()==""or self.entry4.get()=="":
         ...
         try:
            ...
            cur.execute("select * from customerdetails where emailid=%s"
            ...
            if row!=None:
               ...
               cur.execute("insert into customerdetails values(%s,%s,%s,%s)"
   ...
   def appscreen(self):
      ...
      label1=Label(Frame_login,text="THINK FOOD THINK SWIGGY"
      ...
      self.img=ImageTk.PhotoImage(file="s5.jpg")
      
      img=Label(Frame_login,image=self.img).place(x=3,y=40)



      btn2=Button(Frame_login,text="Logout",command=self.loginform,cursor="hand2",

                  font=("times new roman",15),fg="black",bg="red",
   ...
   def screen2(self):
      ...
      label1=Label(Frame_login,text="WELCOME TO SWIGGY ,PLACE YOUR ORDERS HERE"
      ...
      self.img=ImageTk.PhotoImage(file="s9.jpg")

      img=Label(Frame_login,image=self.img).place(x=-200,y=0)
